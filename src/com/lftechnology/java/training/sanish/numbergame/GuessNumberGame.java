...
public class GuessNumberGame {
     ...
     *
     * @param guessNum {@link Integer} user guess number
     * @throws Exception Guess number should be less or equal to [MAX_RANDOM_NUM]
     * @author Sanish Maharjan <sanishmaharjan@lftechnology.com>
     */
