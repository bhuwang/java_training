...
/**
 * <p>
 * NumberPrint Class displays numbers from 1-10.
 * </p>
 * <p>
 * Steps :
 * </p>
 * <ol * type="a">
 * <li>Create a Java application PrintNumber which prints number from 1-10.</li>
...
public class NumberPrint {
    ...
    private static final Logger LOGGER = Logger.getLogger(NumberPrint.class.getName());
    ...
    public static void main(String[] args) {
        ...
        LOGGER.log(Level.INFO, "Numbers from 1-10 are : {0}", new Object[] { numbers });
    }
