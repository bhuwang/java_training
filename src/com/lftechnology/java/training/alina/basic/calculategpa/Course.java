...
public class Course implements Comparable<Course> {
    ...
    public Course(float subject1, float subject2, float subject3, float subject4, float subject5) {
    ...
    public String toString() {
        return "Total Marks : " + getTotalMarks() + ", Percentage : " + getPercentage() + ", Grade : " + getGrade();
    }
