...
public class GameLeagueScores {
    private static final Logger LOGGER = Logger.getLogger(GameLeagueScores.class.getName());
    ...
    public static void main(String[] args) {
        try {
            String results =
                    "Manchester United 1 Chelsea 0," + " Arsenal 1 Manchester United 1," + " Manchester United 3 Fulham 1,"
            ...
            LOGGER.log(Level.INFO, "Game Scores of Manchester United : {0}", new Object[] { getScores });
        } catch (Exception e) {
