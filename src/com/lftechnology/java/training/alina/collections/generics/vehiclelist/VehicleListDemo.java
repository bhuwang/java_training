...
/**
 * Write a program which consists of Generic class VehicleList . In this, list of cars brands and motorbike brands can be removed and added
...
public class VehicleListDemo {
    ...
    private static final Logger LOGGER = Logger.getLogger(VehicleListDemo.class.getName());
    private static VehicleList<Car, Integer> carList = new VehicleList<Car, Integer>();
    private static VehicleList<MotorBike, Integer> motorbikeList = new VehicleList<MotorBike, Integer>();
