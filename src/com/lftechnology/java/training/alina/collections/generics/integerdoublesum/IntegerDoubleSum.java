...
public class IntegerDoubleSum {
	...
	private static final Logger LOGGER =
		Logger.getLogger(IntegerDoubleSum.class.getName());
	...
	private static void getSumUsingDouble() {
		...
		Double totalSum =
			sumDouble.getSumOfNumbers(listDouble, new NumberAdder<Double>() {
	...
	private static void getSumUsingInteger() {
		...
		Integer totalSum =
			sumInteger.getSumOfNumbers(listInteger, new NumberAdder<Integer>() {
