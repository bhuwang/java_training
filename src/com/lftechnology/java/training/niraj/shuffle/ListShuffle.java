...
/**
 * Creates an array list with 49 Integer objects containing the numbers 1 through 49. It then randomly shuffles the list and selects the
 * first 6 values from the shuffled list. Finally, it sorts the selected values and prints them out.
 * 
 * @author Niraj Rajbhandari
 */
public class ListShuffle {

    private static final Logger LOGGER = Logger.getLogger(ListShuffle.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            List<Integer> numberList = listShuffle.getNumberList(scanner, subListLength);
            List<Integer> sortedList = listShuffle.getSortedSubList(numberList, subListLength);
     ...
     */
    public List<Integer> getNumberList(Scanner scanner, int subListLength) throws InputMismatchException {
     ...
     */
    public List<Integer> getSortedSubList(List<Integer> itemList, int subListLength) {

        ShuffleIntListImpl shuffleList = new ShuffleIntListImpl();
        List<Integer> shuffledList = shuffleList.shuffleList(itemList);
        List<Integer> subList = shuffleList.getSubList(shuffledList, subListLength);
