...
public class LinkedListImpl {
    ...
    private static UserStringInputImpl userStringInput = new UserStringInputImpl();
    ...
    private void processLists(List<String> firstList, List<String> secondList) {
        ...
        LOGGER.log(Level.INFO, "Second list with every other element removed:{0}", secondList);

        listService.remove(firstList, secondList);
        LOGGER.log(Level.INFO, "First list without items from second list:{0}", firstList);
